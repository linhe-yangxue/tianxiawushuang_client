...
public static class LuaBinding
{
    ...
    static BindType[] binds = new BindType[]
    {
        ...
        _GT(typeof(CommonWrapper)),
        _GT(typeof(Data)),
        _GT(typeof(DataTable.DataRecord)),
        _GT(typeof(DataTable.NiceTable)),
        _GT(typeof(BaseWrapper)),
        _GT(typeof(BaseObjectWrapper)),
        _GT(typeof(BaseEffectWrapper)),
        _GT(typeof(LuaBehaviourWrapper)),
        _GT(typeof(CoroutineInstruction)),
