...
//----------------
    public bool RestrictWithinBounds(bool instant, SpringPanel.OnFinished finishCallback = null)
    {
        return RestrictWithinBounds(instant, true, true, finishCallback);
    }
...
//-----------
    public bool RestrictWithinBounds(bool instant, bool horizontal, bool vertical, SpringPanel.OnFinished finishCallback = null)
...
//----------------------
                SpringPanel tmpSP = SpringPanel.Begin(mPanel.gameObject, pos, 13f);
                if (tmpSP != null)
                    tmpSP.onFinished = finishCallback;
