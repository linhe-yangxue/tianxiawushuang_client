...
void surf (Input IN, inout SurfaceOutput o) {
	fixed4 splat_control = tex2D_ETC1 (_Control,_MainTex_Alpha, IN.uv_Control);
	fixed4 col;
	col  = splat_control.r * tex2D_ETC1 (_Splat0,_MainTex_Alpha, IN.uv_Splat0);
	col += splat_control.g * tex2D_ETC1 (_Splat1,_MainTex_Alpha, IN.uv_Splat1);
	col += splat_control.b * tex2D_ETC1 (_Splat2,_MainTex_Alpha, IN.uv_Splat2);
	col += splat_control.a * tex2D_ETC1 (_Splat3,_MainTex_Alpha, IN.uv_Splat3);
	o.Albedo = col.rgb;

	fixed4 nrm;
	nrm  = splat_control.r * tex2D_ETC1 (_Normal0,_MainTex_Alpha, IN.uv_Splat0);
	nrm += splat_control.g * tex2D_ETC1 (_Normal1,_MainTex_Alpha, IN.uv_Splat1);
	nrm += splat_control.b * tex2D_ETC1 (_Normal2,_MainTex_Alpha, IN.uv_Splat2);
	nrm += splat_control.a * tex2D_ETC1 (_Normal3,_MainTex_Alpha, IN.uv_Splat3);
