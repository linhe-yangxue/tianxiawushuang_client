...
public class U3DSharkDefine
{
	public const string U3D_SDK_VERSION = "VERSION_1.3";
	/// <summary>
	/// The NOTIFY_ CLAS.
	/// </summary>
	public const  string NOTIFY_CLASS = "U3DSharkSDK";
	/**
	 * config xml path
	 */
	public const string SHARK_SDK_CONFIG_PATH=@"/shark_u3d/recourse/sharkSDKConfig.xml";
	/**
	 * android cur run class
	 */
//	public const string UNIYT_TO_ANDROID_CLASS="com.shark.sdk.android.UnityPlayer";
	public const string UNIYT_TO_ANDROID_CLASS="com.unity3d.player.UnityPlayer";
}

public class U3DSharkAttName
{
    ...
    public const string IS_USE_SDK_EXIT_WINDOW = "support_exit_window";  //是否使用SDK的退出提示框
	...
	public const string PUSH_TITLE = "push_title";   ////推送的标题 string xxxx
