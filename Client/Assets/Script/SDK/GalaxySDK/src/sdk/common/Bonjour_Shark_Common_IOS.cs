...
public class Bonjour_Shark_Common_IOS:Bonjour_Shark_Base
{
	...
	public override void ShowShare(U3DSharkBaseData _in_share)
	{
		CallShowShare(_in_share.DataToString());
	}
	public override void SetPlayerInfo(U3DSharkBaseData data)
	{
	...
	//
	public override void CopyClipboard(U3DSharkBaseData data)
	{
	...
	//1.增加一个本地推送
	public override void AddLocalPush(U3DSharkBaseData data)
	{
