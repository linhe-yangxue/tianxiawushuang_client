...
public class PeakTreasureWindow : tWindow
{
    ...
    public override void Open(object param)
    {
        ...
        SetText("tips_label", "点击宝箱三选一，切莫贪心哦！");
        ...
        hasChoosed = info == null || info.mAwardItem == null;
        hasAllOpened = info == null || info.mAwardItem == null;
    ...
    private void OnClick(string target)
    {
        ...
        {
            hasChoosed = true;
            PerformEffect(target, info.mAwardItem);
