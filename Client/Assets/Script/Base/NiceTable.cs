...
namespace DataTable
{
	...
	public class NiceTable
	{
		...
		public bool LoadBinary(string pathFile)
		{
			if (!File.Exists(pathFile))
			{
				DEBUG.LogError("Table file no exist>"+pathFile);
				return false;
			}
			bool re = false;
...
//            try
//            {
//                AESCrypto tmpAESCrypto = new AESCrypto();
//                byte[] tmpEncode = tmpAESCrypto.Encode(data.getData());
//                data._resize(0);
//                data.write(tmpEncode);
//            }
//            catch (System.Exception ex)
//            {
//                DEBUG.LogError("NiceTable serialize failed");
//            }
...
//                AESCrypto tmpAESCrypto = new AESCrypto();
//				DEBUG.Log ("出错位置11111=====");
//                byte[] tmpEncode = tmpAESCrypto.Decode(data.getData());
//				DEBUG.Log ("出错位置22222=====");
//                data._resize(0);
//				DEBUG.Log ("出错位置33333=====");
//                data.write(tmpEncode);
...
//            catch (System.Exception ex)
//            {
//                DEBUG.LogError("NiceTable restore failed");
//            }
