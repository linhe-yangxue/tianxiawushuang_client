...
public static class vp_TimeUtility
{
	...
	/// </summary>
    public static string TimeToString(float timeInSeconds, bool showHours = true, bool showMinutes = true, bool showSeconds = true,
										bool showTenths=false, bool showHundredths=false, bool showMilliSeconds=false,
										char delimiter = ':')
	{
