...
namespace Asset
{
    ...
    {
#if !UNITY_WP8
        private static System.Security.Cryptography.MD5CryptoServiceProvider provider = null;
#endif
        public static string GetMD5(string fileName)
        {
            string tmpMD5 = null;
#if UNITY_WP8
        tmpMD5 = System.BitConverter.ToString(MD5Core.GetHash(System.IO.File.ReadAllBytes(fileName))).Replace("-", "");
#else
            if (provider == null) provider = new System.Security.Cryptography.MD5CryptoServiceProvider();
            using (System.IO.FileStream fs = new System.IO.FileStream(fileName, System.IO.FileMode.Open))
            {
                tmpMD5 = System.BitConverter.ToString(provider.ComputeHash(fs)).Replace("-", "");
            }
#endif
            return tmpMD5;
        }
