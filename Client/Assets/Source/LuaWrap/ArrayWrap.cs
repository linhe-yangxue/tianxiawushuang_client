...
public class ArrayWrap
{
	...
	static int GetValue(IntPtr L)
	{
		...
		if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(Array), typeof(long)))
		{
			Array obj = LuaScriptMgr.GetNetObject<Array>(L, 1);
	...
	static int SetValue(IntPtr L)
	{
		...
		if (LuaScriptMgr.CheckTypes(L, 1, typeof(Array), typeof(object)) && LuaScriptMgr.CheckParamsType(L, typeof(long), 3, count - 2))
		{
			Array obj = LuaScriptMgr.GetNetObject<Array>(L, 1);
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Array), typeof(object), typeof(long)))
		{
			Array obj = LuaScriptMgr.GetNetObject<Array>(L, 1);
			object arg0 = LuaScriptMgr.GetVarObject(L, 2);
			long arg1 = (long)LuaScriptMgr.GetNumber(L, 3);
	...
	static int CreateInstance(IntPtr L)
	{
		...
		if (LuaScriptMgr.CheckTypes(L, 1, typeof(Type)) && LuaScriptMgr.CheckParamsType(L, typeof(long), 2, count - 1))
		{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(Type), typeof(int)))
		{
			Type arg0 = LuaScriptMgr.GetTypeObject(L, 1);
